#!/usr/bin/env python3
"""
NRJ Statistikk Dashboard - Samlet visning av NRJ tall
Henter og viser:
- Nielsen Radio tall (NRJ)
- Podtoppen tall (NRJ Morgen Podkast)

Lagrer i Supabase med formatert HTML for dashboard-visning
"""
...
def insert_to_supabase(html_content, nielsen_data, podtoppen_data):
...
def main():
    ...
    if nielsen_data:
        print(f"   ✅ {nielsen_data['daily_reach']:,} daglige lyttere")
    else:
    ...
    if nielsen_data and podtoppen_data:
        ...
        if insert_to_supabase(html, nielsen_data, podtoppen_data):
            print()
            print("=" * 60)
            ...
            print()
            print("📍 Plassering: Øverst i dashboardet (pinned)")
        else:
