...
### MANDATORY: Auto-Exec Enforcer (CANNOT BE SKIPPED)
...
**This script:**
1. FORCES you to run mandatory-preflight.sh
2. CANNOT be skipped - will exit if not run
3. Creates completion markers
4. Logs all executions

**If you try to skip this:**
- You will NOT have full context
- You will make mistakes
- You are FAILING your duty
